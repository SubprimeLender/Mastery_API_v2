<?php
	include 'variables/adc_array.php'; //ADC multi-array reference page
	...
	*/
		...
		$champ_laning, $champ_kiting, $champ_support1, $champ_dodging, $champ_teamfighting, $champ_support2, $champ_positioning, $champ_dueling, $champ_landing, $champ_support3, $weighted_average) 
	{
		...
		//Sums up the differences between user's answers and each ADC's pre-determined attributes from adc_array2.php. Note the 3 support questions are given 50% weight
		$sum = 
		...
		return intval($sum/$weighted_average);
	};
